...
import { getNotifications, markNotificationRead } from '../../api/staff'
          ...
          <div className="space-y-3">
            {notifications.map(n => (
              <div
                ...
                className={`card cursor-pointer transition-all hover:shadow-md ${!n.isRead ? 'border-l-4 border-l-primary-500' : 'opacity-75'}`}
              >
